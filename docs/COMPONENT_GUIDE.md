...
**Usage**: `/register` page
**Dependencies**: CountryCodeSelector, myanmarRegions
...
**Dependencies**: useChat hook, SimpleOfferModal, UserBadgeSystem
...
### ReviewSliderModal.tsx
**Purpose**: Modal for viewing multiple reviews with slider navigation
**Key Features**:
- Slider-based review navigation
- Search and filter functionality
- Rating-based filtering
- Sort options (newest, oldest, highest, lowest)
- Review counter and pagination dots
- Product information display for each review
- Responsive design for mobile and desktop
**Props**: `isOpen`, `onClose`, `reviews`, `totalReviews`, `averageRating`
**Usage**: Seller storefronts and user profiles when viewing all reviews
**Dependencies**: Dialog, Search, Filter, Star rating components
